"""HadaMaxIndex — compressed approximate nearest-neighbor search.
...
class HadaMaxIndex:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"HadaMaxIndex(dim={self.dim}, bits={self.bits}, "
    ...
    def save(self, path: str | Path) -> None:
        """Persist index to a binary ``.hdmx`` file (atomic write).
    ...
    @classmethod
    def load(cls, path: str | Path) -> "HadaMaxIndex":
        """Load index from a ``.hdmx`` file.
